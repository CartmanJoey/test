...
LibJavascript.RequireLibrary("../binframework/extjs/sweetalert2/dist/sweetalert2.min.js");
//LibJavascript.RequireLibrary("../binframework/extjs/sweetalert2/dist/sweetalert2.js");
...
function hrifAlertSuccessDestroy(textValue, titleValue, form, fromParent){
	...
	if (window.top && fromParent!=1){
		window.top.LibJavascript.RequireLibrary("../binframework/js/hrif2_enum.js");
		window.top.LibJavascript.RequireLibrary("../binframework/js/hrif2_systemdialog.js");
...
function hrifAlertInfoWait(textValue, titleValue, icon, fromParent){
	...
	if ((window.top && !HRMIsActive()) && fromParent!=1){
		window.top.LibJavascript.RequireLibrary("../binframework/js/hrif2.js");
		window.top.LibJavascript.RequireLibrary("../binframework/js/hrif2_enum.js");
		window.top.LibJavascript.RequireLibrary("../binframework/js/hrif2_systemdialog.js");
//		window.top.addEventListener("message", function(event) {
...
function hrifCheckVersionTop(){
	...
	var result = false;
	window.top.LibJavascript.RequireLibrary("../binframework/js/hrif2_tools.js");
